...
export const PERJADIN_PHASES = [
  ...
  },
  {
    ...
    items: [
      ...
      { template_id: 'sptjm-pelaksana',      definition_id: 'sptjm-pelaksana',         kode: 'SPTJM',  surat_nama: 'SPTJM Pelaksana',         icon: '', warna: '#475569', urutan: 15, depends_on: ['spby'], assign_to_role: 'admin',     per_pegawai: false },
