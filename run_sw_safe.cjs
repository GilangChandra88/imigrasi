...
// Update FieldFormView for row_multi
const formOld = `if (field.type === "row_multi") {
...
swCode = swCode.replace(formOld, formNew);

const docOld = `if (sub.type === "row_multi") {
